# Generated by Django 4.1 on 2023-07-08 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('name', models.CharField(max_length=255, validators=[django.core.validators.RegexValidator(message='属性命名只能为大小写英文字母', regex='^[a-zA-Z]+$'), django.core.validators.MaxLengthValidator(255, message='属性名称不超过254个字符')], verbose_name='属性名')),
                ('data_type', models.CharField(choices=[('string', '字符串'), ('number', '数值'), ('boolean', '布尔值')], max_length=255, verbose_name='数据类型')),
                ('data_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fills.dataset', verbose_name='关联数据集')),
            ],
            options={
